  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl p-10 relative z-10 border border-gray-100"
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-black text-gray-900">番茄专注 · Login</h2>
          <p className="text-gray-400 text-sm mt-1 font-medium italic">追求卓越专注体验</p>
        </div>
